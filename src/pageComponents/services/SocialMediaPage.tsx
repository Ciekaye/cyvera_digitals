...
export default function SocialMediaPage() {
  ...
  const features = [
    { icon: CalendarDays, title: "Content Planning", description: "Strategic content calendars aligned with your brand voice, goals, and audience behavior." },
    { icon: Camera, title: "Content Creation", description: "Engaging graphics, captions, reels, and stories crafted to capture attention and drive action." },
    { icon: Share2, title: "Account Management", description: "Daily posting, community engagement, and profile optimization across all major platforms." },
    { icon: BarChart3, title: "Analytics & Reporting", description: "Monthly performance reports with actionable insights to continuously improve your strategy." },
    { icon: MessageCircle, title: "Community Engagement", description: "Active interaction with your audience to build relationships and foster brand loyalty." },
    { icon: TrendingUp, title: "Growth Strategy", description: "Data-driven strategies to grow your following, reach, and engagement organically." },
  ];
  ...
  const packages = [
    { name: "Starter", posts: "12 posts/month", includes: ["Content calendar", "Graphic design", "Basic analytics", "1 platform"] },
    { name: "Growth", posts: "20 posts/month", includes: ["Content calendar & strategy", "Graphic design + reels", "Community management", "Monthly reporting", "Up to 3 platforms"], highlighted: true },
    { name: "Scale", posts: "30+ posts/month", includes: ["Full content strategy", "Custom graphics, reels & stories", "Daily community management", "Weekly analytics", "All platforms"] },
  ];
    ...
    <div ref={ref} className="bg-modern-primary min-h-screen">
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4 lg:px-8">
          ...
          >
            Full-service social media management to grow your online presence.
          </motion.p>
      ...
      <section className="relative py-20 overflow-hidden bg-white">
        ...
        <div className="absolute inset-0 w-full h-full">
          ...
          >
            <defs>
              ...
              <linearGradient id="pw3" x1="0%" y1="0%" x2="100%" y2="0%">
                <stop offset="0%" stopColor="#d946ef" stopOpacity="0.25" />
                <stop offset="60%" stopColor="#818cf8" stopOpacity="0.2" />
            ...
            <path fill="url(#pw3)" opacity="0.7" d="M0,260 C200,160 400,340 600,240 C800,140 1000,300 1200,220 C1350,160 1420,260 1440,240 L1440,500 L0,500 Z" />
            <path fill="url(#pw2)" opacity="0.85" d="M0,310 C160,220 360,380 580,280 C760,190 980,350 1180,260 C1340,190 1410,290 1440,270 L1440,500 L0,500 Z" />
            <path fill="url(#pw1)" opacity="0.9" d="M0,350 C180,260 360,420 580,330 C760,250 960,400 1180,310 C1340,240 1410,330 1440,315 L1440,500 L0,500 Z" />
        ...
        <div className="container mx-auto px-4 lg:px-8 relative z-10">
          ...
          <motion.p
            ...
            className="text-center text-gray-600 mb-14 max-w-2xl mx-auto"
          >
            We create and manage content across all major social media platforms.
          </motion.p>
                  ...
                  >
                    <Image
                      ...
                      onError={(e) => {
                        ...
                        (e.target as HTMLImageElement).parentElement!.innerHTML = `<span style="font-weight:700;font-size:18px;color:${platform.color}">${platform.name.charAt(0)}</span>`;
                      }}
                    />
                  </div>
              ...
              >
                {pkg.highlighted && (
                  <div className="absolute -top-3.5 left-1/2 -translate-x-1/2">
                    <span className="px-4 py-1 rounded-full text-xs font-bold text-white bg-gradient-primary shadow-md">
                      Popular
                    </span>
                  </div>
                )}
